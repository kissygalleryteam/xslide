 ...
 * @module xslide 
 **/
KISSY.add('kg/xslide/1.1.3/index',function(S, Node, Base, Pan) {
    var $ = S.all;
    ...
    var XSlide = Base.extend({
        ...
        evtBind: function() {
            ...
            $renderTo.on(Pan.PAN_START, function(e) {
                transX = self.getPosX();
        ...
        destroy: function() {
            ...
            self.$renderTo.detach(Pan.PAN_START);
            self.$renderTo.detach(Pan.PAN);
            self.$renderTo.detach(Pan.PAN_END)
    ...
    requires: ['node', 'base', "kg/xscroll/1.1.8/pan"]
});
